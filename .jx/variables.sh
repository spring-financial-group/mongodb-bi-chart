...
export JENKINS_X_URL='https://dashboard-jx.jx.mqube.build/spring-financial-group/mongodb-bi-chart/main/5'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/mongodb-bi-chart:0.0.14'
