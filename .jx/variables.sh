...
export APP_NAME='mongodb-bi-chart'
...
export JENKINS_X_URL='https://dashboard-jx.jx.mqube.build/spring-financial-group/mongodb-bi-chart/main/1'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/mongodb-bi-chart:0.0.23'
export NAMESPACE_SUB_DOMAIN='-jx.'
export PIPELINE_KIND='release'
export PUSH_CONTAINER_REGISTRY='jx3mqubebuild.azurecr.io'
export REPO_NAME='mongodb-bi-chart'
